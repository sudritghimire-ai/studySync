...
import { useSidebarStore } from "../store/useSidebarStore"; // add this
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-slate-900 via-purple-950/40 to-indigo-950/60 relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-500/3 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-amber-500/3 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "2s" }} />
        <div className="absolute top-2/3 left-1/2 w-64 h-64 bg-indigo-500/3 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "4s" }} />
      </div>
      ...
      <div className="flex flex-col flex-grow relative z-10 max-w-3xl mx-auto w-full overflow-hidden">
              ...
              return (
                ...
                >
                  ...
                  <div className={`flex flex-col ${isOwn ? "items-end" : "items-start"} max-w-md lg:max-w-lg`}>
                    ...
                    {showTimestamp && (
                      <div
                        className={`flex items-center gap-2 mt-1 px-2 opacity-0 group-hover:opacity-100 transition ${
        ...
        <div className="relative px-4 py-3 max-w-3xl mx-auto w-full">
          <div className="absolute inset-0 bg-slate-900/80 backdrop-blur-xl shadow-lg" />
...
const MatchNotFound = () => (
  <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-purple-950/40 to-indigo-950/60 relative overflow-hidden">
    <div className="absolute inset-0 pointer-events-none">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-amber-500/5 rounded-full blur-2xl" />
    </div>
...
const LoadingMessagesUI = () => (
  <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-purple-950/40 to-indigo-950/60">
    <div className="relative">
      <div className="w-10 h-10 border-3 border-slate-700/30 border-t-amber-500 rounded-full animate-spin" />
      <div
